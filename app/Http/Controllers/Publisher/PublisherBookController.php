...
class PublisherBookController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        'photo'           => 'nullable|image|mimetypes:image/jpeg,image/png,image/jpg,image/gif,image/svg,image/webp|max:20480',
        'photo_2'         => 'nullable|image|mimetypes:image/jpeg,image/png,image/jpg,image/gif,image/svg,image/webp|max:20480',
        'photo_3'         => 'nullable|image|mimetypes:image/jpeg,image/png,image/jpg,image/gif,image/svg,image/webp|max:20480',
        'photo_4'         => 'nullable|image|mimetypes:image/jpeg,image/png,image/jpg,image/gif,image/svg,image/webp|max:20480',
