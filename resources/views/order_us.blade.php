...
<h5 class="section-title" style="position: relative; margin-bottom:25px; padding-bottom:25px; align-items: left;
    justify-content: left;">     <strong>
       <i class="bi bi-box-fill"></i> შეგვიკვეთე
    </strong>
</h5>
...
<div class="container d-flex ">
    <div class="col-md-6" style="border: 1px solid rgb(165, 158, 158); border-radius:3px; font-weight: 100"> 
        <button type="button" class="btn btn-light text-start w-100">
            თუ ჩვენს ვებსაიტზე ვერ აღმოაჩინე სასურველი ბუკინისტური წიგნი, შეავსე ველები და შეგვიკვეთე.
...
<form action="{{ route('order.request.book') }}" method="POST">
    ...
    <div class="form-group mb-3">
        <label for="title">წიგნის სახელწოდება</label>
        <div class="input-group">
            ...
            <input type="text" class="form-control" id="title" name="title" placeholder="მაგ: დედა ენა" required>
        </div>
    </div>

    <!-- Book Author -->
    <div class="form-group mb-3">
        <label for="author">წიგნის ავტორი</label>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text">
            ...
            <input type="text" class="form-control" id="author" name="author" placeholder="მაგ: იაკობ გოგებაშვილი" required>
        </div>
    </div>

    <!-- Publishing Year (Optional) -->
    <div class="form-group mb-3">
        <label for="publishing_year">გამოცემის წელი (არასავალდებულო)</label>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text">
            ...
            <input type="text" class="form-control" id="publishing_year" name="publishing_year" placeholder="მაგ: 1876">
        </div>
    </div>
    ...
    <div class="form-group mb-4">
        ...
        <div class="input-group">
            ...
            <textarea class="form-control" id="comment" name="comment" rows="3" placeholder="თქვენი კომენტარი აქ..." required></textarea>
        </div>
    </div>

    <!-- Submit Button -->
    <button type="submit" class="btn btn-primary btn-block">
        <i class="bi bi-send"></i> გამოგვიგზავნე შეკვეთა
    </button>
</form>
...
<div class="container d-flex ">
    ...
    <button type="button" class="btn btn-warning text-center">
        <span>  შეკვეთის საშუალება მხოლოდ რეგისტრირებულ მომხმარებლებს აქვთ. 
            დარეგისტრირდი ან თუ უკვე რეგისტრირებული ხარ, გაიარე ავტორიზაცია </span>
    </button>
