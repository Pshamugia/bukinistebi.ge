...
<div class="container" style="position: relative; top:30px; ">
    ...
    <form action="{{ route('account.update') }}" method="POST">
        ...
        <div class="mb-3 input-group">
            ...
            <input type="text" name="phone" value="{{ old('phone', auth()->user()->phone) }}" class="form-control" placeholder="მობილური">
        </div>
        ...
        <div class="mb-3 input-group">
            ...
            <input type="text" name="address" value="{{ old('address', auth()->user()->address) }}" class="form-control" placeholder="მისამართი">
        </div>
